...
## 🔥BRKXXX: Jumpstart AI-powered HR and IT support with Employee Self-Service Agent
...
Jumpstart AI-powered HR and IT support with Microsoft’s Employee Self-Service Agent at Ignite 2025. Learn how to streamline workflows, boost productivity, and integrate Azure AI tools for smarter enterprise solutions.

### 🧠 Learning Outcomes

By the end of this session, learners will be able to:

- Understand how to configure and customize Employee Self-Service (ESS) Copilot Agents for HR and IT workflows.
- Learn to integrate Microsoft AI tools with ServiceNow and SharePoint connectors for real-time support scenarios.
- Gain hands-on experience deploying agents in Microsoft Cloud Services (MCS) developer environments.
- Explore adaptive card actions, live agent handoff, and third-party agent integration for enterprise use cases.

### 💻 Technologies Used

1. Microsoft Cloud Services (MCS) for hosting and orchestration.
2. SharePoint for documentation and resource sharing.
3. ServiceNow for ITSM integration and HR case management.
4. Power Platform for automation, adaptive cards, and workflow customization.
